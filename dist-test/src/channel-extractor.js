...
class ChannelExtractor {
    async extractChannelMessages() {
        ...
        const messages = [];
        const messageSet = new Set(); // For deduplication within the view (though list shouldn't have dups normally)
        // 3. Extract Details
        messageItems.forEach((item) => {
            ...
            if (timestampEl) {
                ...
                if (tsAttr) {
                    timestamp = message_formatter_js_1.MessageFormatter.formatTimestamp(tsAttr.split(".")[0]);
                }
            ...
            const tsvLine = message_formatter_js_1.MessageFormatter.formatToTSV(rawMessage);
...
//# sourceMappingURL=channel-extractor.js.map