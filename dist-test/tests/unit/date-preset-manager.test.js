...
const date_preset_manager_js_1 = require("../../src/date-preset-manager.js");
(0, node_test_1.describe)('DatePresetManager', () => {
    // Fixed reference date: 2025-12-20 (Saturday)
    // Month is 0-indexed in JS Date: 11 is December
    const mockToday = new Date(2025, 11, 20);
    const manager = new date_preset_manager_js_1.DatePresetManager();
    (0, node_test_1.it)('should calculate correct date range for "today"', () => {
        const range = manager.calculateDateRange('today', mockToday);
        node_assert_1.default.strictEqual(range.startDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.startDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.startDate.getDate(), 20);
        node_assert_1.default.strictEqual(range.endDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.endDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.endDate.getDate(), 20);
    });
    (0, node_test_1.it)('should calculate correct date range for "yesterday"', () => {
        const range = manager.calculateDateRange('yesterday', mockToday);
        node_assert_1.default.strictEqual(range.startDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.startDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.startDate.getDate(), 19);
        node_assert_1.default.strictEqual(range.endDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.endDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.endDate.getDate(), 19);
    });
    (0, node_test_1.it)('should calculate correct date range for "week" (last 7 days)', () => {
        ...
        node_assert_1.default.strictEqual(range.startDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.startDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.startDate.getDate(), 14); // 20 - 6
        node_assert_1.default.strictEqual(range.endDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.endDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.endDate.getDate(), 20);
    });
    (0, node_test_1.it)('should calculate correct date range for "month" (last 30 days)', () => {
        ...
        node_assert_1.default.strictEqual(range.startDate.getFullYear(), expectedStart.getFullYear());
        node_assert_1.default.strictEqual(range.startDate.getMonth(), expectedStart.getMonth());
        node_assert_1.default.strictEqual(range.startDate.getDate(), expectedStart.getDate());
        node_assert_1.default.strictEqual(range.endDate.getFullYear(), 2025);
        node_assert_1.default.strictEqual(range.endDate.getMonth(), 11);
        node_assert_1.default.strictEqual(range.endDate.getDate(), 20);
    });
    (0, node_test_1.it)('should generate correct Slack query for "today"', () => {
        ...
        node_assert_1.default.strictEqual(query, 'on:2025-12-20');
    });
    (0, node_test_1.it)('should generate correct Slack query for "yesterday"', () => {
        const query = manager.toSlackQuery('yesterday', mockToday);
        node_assert_1.default.strictEqual(query, 'on:2025-12-19');
    });
    (0, node_test_1.it)('should generate correct Slack query for "week"', () => {
        // Start date 2025-12-14 -> after 2025-12-13
        const query = manager.toSlackQuery('week', mockToday);
        node_assert_1.default.strictEqual(query, 'after:2025-12-13');
    });
    (0, node_test_1.it)('should generate correct Slack query for "month"', () => {
        // Start date 2025-11-21 -> after 2025-11-20
        const query = manager.toSlackQuery('month', mockToday);
        node_assert_1.default.strictEqual(query, 'after:2025-11-20');
    });
});
//# sourceMappingURL=date-preset-manager.test.js.map