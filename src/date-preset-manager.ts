import { DatePreset, DateRange } from './types.js';

export class DatePresetManager {
  
  public calculateDateRange(preset: DatePreset, referenceDate: Date = new Date()): DateRange {
  ...
  public toSlackQuery(preset: DatePreset, referenceDate: Date = new Date()): string {
