...
export class MessageFormatter {
   ...
   */
  static formatToTSV(message: RawMessage): string {
   ...
   */
  static escapeRegExp(stringValue: string): string {
   ...
   */
  static escapeXSS(text: string): string {
   ...
   */
  static convertLinksToMarkdown(text: string): string {
  ...
  static formatTimestamp(timestamp: string): string {
    if (!timestamp || isNaN(Number(timestamp))) return timestamp;
